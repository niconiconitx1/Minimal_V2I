...
void run_detector(int argc, char **argv)
{
    ...
    // niconeco
    //char *datacfg = argv[3];
    char *datacfg = "cfg/combine9k.data";
    //char *cfg = argv[4];
    char *cfg = "cfg/yolo9000.cfg";
    //char *weights = (argc > 5) ? argv[5] : 0;
    char *weights = "../yolo9000-weights/yolo9000.weights";
    //char *filename = (argc > 6) ? argv[6]: 0;
    char *filename = "img/test_cam.jpg";
    
    
    //./darknet detector test cfg/combine9k.data cfg/yolo9000.cfg ../yolo9000-weights/yolo9000.weights data/horses.jpg
    
    //argv[6] = "data/horses.jpg";
    //strncpy(filename,"data/horses.jpg",256);
