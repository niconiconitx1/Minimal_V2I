...
def read_cam():
 ...
 #   imtest = cv2.imread(cap,cv2.IMREAD_COLOR)
   # cap  = cv2.VideoCapture("nvcamerasrc fpsRange=1.0 1.0 ! 'video/x-raw(memory:NVMM), width=(int)448, height=(int)448, format=(string)I420, framerate=(fraction)1/10' ! nvtee ! nvvidconv flip-method=2 ! jpegenc ! multifilesink location=./frame%06d.jpg")
#    cv2.imwrite('test_cam.jpg',imtest)
'''
    ...
    cv2.imwrite('/home/nvidia/project/yolo-9000/darknet/examples/test_cam.jpg',frame)
'''
    ...
    if cap.isOpened():
        ...
        while True:
            ...
            if key == 27: # Check for ESC key
                ...
                showWindow=1            
	        cv2.imwrite('/home/nvidia/Downloads/yolo-9000/darknet/examples/test_cam.jpg',frame)
		...
		gray_frame = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
	        ...
	        cv2.imwrite('/home/nvidia/Downloads/yolo-9000/darknet/examples/test_cam.jpg',gray_frame)
